class ApiEndpoints {
  ...
  // New event participant endpoints
  static getEventParticipants(String eventId) => Uri(
        scheme: scheme,
        host: host,
        port: port,
  ...
  static getPendingParticipants(String eventId) => Uri(
        scheme: scheme,
        host: host,
        port: port,
  ...
  static approveParticipant(String eventId, String userId) => Uri(
        scheme: scheme,
        host: host,
        port: port,
        path: 'api/events/$eventId/participants/$userId/approve',
      );

  static rejectParticipant(String eventId, String userId) => Uri(
        scheme: scheme,
        host: host,
        port: port,
        path: 'api/events/$eventId/participants/$userId/reject',
      );

  static removeParticipant(String eventId, String userId) => Uri(
        scheme: scheme,
        host: host,
        port: port,
  ...
  static getEventCreatorName(int eventId) => Uri(
        ...
        host: host,
        port: port,
        path: 'api/events/$eventId/creator-name',
      );
