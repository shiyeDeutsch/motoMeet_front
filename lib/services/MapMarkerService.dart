...
class MapMarkerService {
  ...
  Future<void> getMarkers() async {
    //   final ProviderContainer container = providerContainer; // Create a new ProviderContainer
    // final stateNotifier = container.read(markerListProvider.notifier);
    ...
    //   ),
    // );
    //  stateNotifier.addMarker(locationMarker);
