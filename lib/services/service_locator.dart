...
import 'package:motomeetfront/services/userRouteService.dart';
...
Future<void> setupLocator( )async  {
  ...
  // Register the new UserRouteService
  GetIt.I.registerLazySingleton<UserRouteService>(() => UserRouteService());
