...
class IsarUserRecentActivityRepository {
  final Isar _isar;

  IsarUserRecentActivityRepository( Isar isar) : _isar = isar;

  // Future<List<UserRecentActivity>> getActivities({
  //   int skip = 0,
  //   int limit = 20,
  // }) async {
  ...
  Future<UserRecentActivity?> getActivity(String id) async {
  ...
  // Future<void> saveActivity(UserRecentActivity activity) async {
  ...
  // Future<void> saveActivities(List<UserRecentActivity> activities) async {
...
//   factory ActivityDto.fromActivity(UserRecentActivity activity) {
