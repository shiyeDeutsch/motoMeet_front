...
UserInfo _userInfoDeserialize(
  ...
  final object = UserInfo(
    ...
    countryId: reader.readLong(offsets[2]),
...
extension UserInfoQueryFilter
  ...
  QueryBuilder<UserInfo, UserInfo, QAfterFilterCondition> ageEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserInfo, UserInfo, QAfterFilterCondition> ageGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserInfo, UserInfo, QAfterFilterCondition> ageLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserInfo, UserInfo, QAfterFilterCondition> ageBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension UserInfoQuerySortBy on QueryBuilder<UserInfo, UserInfo, QSortBy> {
  QueryBuilder<UserInfo, UserInfo, QAfterSortBy> sortByAge() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'age', Sort.asc);
    });
  }

  QueryBuilder<UserInfo, UserInfo, QAfterSortBy> sortByAgeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserInfoQuerySortThenBy
  ...
  QueryBuilder<UserInfo, UserInfo, QAfterSortBy> thenByAge() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'age', Sort.asc);
    });
  }

  QueryBuilder<UserInfo, UserInfo, QAfterSortBy> thenByAgeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'age', Sort.desc);
    });
  }
...
extension UserInfoQueryWhereDistinct
  ...
  QueryBuilder<UserInfo, UserInfo, QDistinct> distinctByAge() {
    return QueryBuilder.apply(this, (query) {
...
extension UserInfoQueryProperty
  ...
  QueryBuilder<UserInfo, int, QQueryOperations> ageProperty() {
    return QueryBuilder.apply(this, (query) {
